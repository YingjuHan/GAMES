...
function GAMES202Main() {
	...
	*/
	...
	depthMaterial = buildSceneDepthMipmapMaterial(depthTexture, "./src/shaders/sceneDepthShader/depthVertex.glsl", "./src/shaders/sceneDepthShader/depthFragment.glsl");
