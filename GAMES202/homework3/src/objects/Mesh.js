...
class Mesh {
	...
	static Quad(transform) {
		...
		const indices = [0, 1, 2, 1, 2, 3]; // front

		return new Mesh({ name: 'aVertexPosition', array: new Float32Array(positions) }, null, { name: 'aTextureCoord', array: new Float32Array(textcoords) }, indices, transform);
	}
}
